...
![1557123925570](assets/1557123925570.png)

- VMware软件 -> 选择hadoop101 -> 点击“编辑虚拟机设置” -> 选择“网络适配器” -> 选择 VMnet8 -> 点击确定

![20190528151245](assets/20190528151245.png)

#### 1.2 VMnet8网络适配器配置

- 回到windows –> 打开网络和共享中心 -> 更改适配器设置 -> 右键VMnet8网络适配器 -> 属性 -> 双击IPv4 -> 设置虚拟网卡VMnet8的`IP: 192.168.2.5 子网掩码: 255.255.255.0` (可选：`默认网关: 192.168.2.1 首选DNS服务器: 192.168.2.1`) -> 点击确定 

![VMnet8配置](assets/VMnet8配置.png)
...
![1557124878618](assets/1557124878618.png)
...
![克隆虚拟机](assets/克隆虚拟机.png)

#### 6.3 欢迎页面

![1557112663409](assets/1557112663409.png)

#### 6.4 克隆虚拟机

![1557112854624](assets/1557112854624.png)

#### 6.5 设置创建完整克隆

![1557112884695](assets/1557112884695.png)

#### 6.6 设置克隆的虚拟机名称和存储位置

![1557112904183](assets/1557112904183.png)

- 虚拟机名称和主机名可以不一致
#### 6.7 等待正在克隆

![1557112918606](assets/1557112918606.png)

#### 6.8 点击关闭，完成克隆

![1557112929262](assets/1557112929262.png)

#### 6.9 修改克隆后虚拟机网卡

![1557112952425](assets/1557112952425.png)
...
![1557123372791](assets/1557123372791.png)

											图2-28  导入JDK

- “alt+p”进入sftp模式，如图2-29所示

![1557123394181](assets/1557123394181.png)

											图2-29 进入sftp模式

- 选择jdk1.8拖入，如图2-30，2-31所示

![1557123413780](assets/1557123413780.png)

											图2-30 拖入jdk1.8

![1557123425278](assets/1557123425278.png)
...
```
		...
		如果提示：sudo: source: command not found，换成以下命令
		[atguigu@hadoop101 jdk1.8.0_144]$ sudo -s source /etc/profile
```
